...
public class DisUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public static final String SPRING_SECURITY_FORM_LOGINID_KEY = "equip";
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        username = username + USERNAME_LOGINID_SPLIT + loginid ;   //将设备号与登录用户名使用 / 连接起来
		
		request.getSession().setAttribute(SPRING_SECURITY_FORM_LOGINID_KEY, loginid)
